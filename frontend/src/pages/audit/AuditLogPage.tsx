...
const EVENT_META: Record<AuditAction, StatusMeta> = {
  ...
  bank_import_batch_reversed:  { v: 'danger',  labelKey: 'audit.event.bank_import_batch_reversed' },
  reconciliation_confirmed:    { v: 'success',   labelKey: 'audit.event.reconciliation_confirmed' },
  reconciliation_reversed:     { v: 'danger',  labelKey: 'audit.event.reconciliation_reversed' },
  client_credit_applied:       { v: 'success',   labelKey: 'audit.event.client_credit_applied' },
  manual_receivable_created:   { v: 'success',   labelKey: 'audit.event.manual_receivable_created' },
  manual_receivable_updated:   { v: 'info', labelKey: 'audit.event.manual_receivable_updated' },
  manual_receivable_cancelled: { v: 'danger',  labelKey: 'audit.event.manual_receivable_cancelled' },
  dunning_sent:                { v: 'info', labelKey: 'audit.event.dunning_sent' },
  dunning_paused:              { v: 'warn', labelKey: 'audit.event.dunning_paused' },
  dunning_resumed:             { v: 'success',   labelKey: 'audit.event.dunning_resumed' },
  user_created:                { v: 'success',   labelKey: 'audit.event.user_created' },
  invitation_accepted:         { v: 'success',   labelKey: 'audit.event.invitation_accepted' },
  user_updated:                { v: 'info', labelKey: 'audit.event.user_updated' },
  user_deleted:                { v: 'danger',  labelKey: 'audit.event.user_deleted' },
  organization_created:        { v: 'success',   labelKey: 'audit.event.organization_created' },
  organization_deleted:        { v: 'danger',  labelKey: 'audit.event.organization_deleted' },
  login_succeeded:             { v: 'success',   labelKey: 'audit.event.login_succeeded' },
  login_failed:                { v: 'danger',  labelKey: 'audit.event.login_failed' },
  clear_settings_updated:      { v: 'info', labelKey: 'audit.event.clear_settings_updated' },
  mfa_enabled:                 { v: 'success',   labelKey: 'audit.event.mfa_enabled' },

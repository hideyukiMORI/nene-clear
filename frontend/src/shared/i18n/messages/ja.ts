export const ja = {
  ...
  'dunning.stageLabel': '段階',
  'dunning.stage.initial': '初回',
  'dunning.stage.reminder': '再督促',
  'dunning.stage.final': '最終',
  'dunning.previewLabel': 'プレビュー（送信される内容）',
  'dunning.previewLoading': 'プレビューを読み込み中…',
  'dunning.previewUnavailable': 'プレビューを取得できませんでした。',
  'dunning.previewTo': '宛先',
  'dunning.testSendLabel': 'テスト送信（自分宛に確認）',
  'dunning.testToPlaceholder': 'you@example.com',
  'dunning.testSend': 'テスト送信',
  'dunning.testSent': '{to} にテスト送信しました',
  'dunning.pause': '停止',
  ...
  'audit.event.invitation_accepted': '招待受諾（アカウント有効化）',
  ...
  'manualReceivables.clientNamePlaceholder': '例: 山田商店 / 田中太郎',
  ...
  // ── Glossary (簿記用語の注釈・改名はしない / terminology registry §domain) ──
  'glossary.label': '用語の説明',
  'glossary.reconcile.term': '消込（けしこみ）',
  'glossary.reconcile.def': '入金と請求を突き合わせて「支払い済み」として消す作業。売掛金の残高を正しく保つための処理です。',
  'glossary.match.term': '突合（とつごう）',
  'glossary.match.def': '銀行の入金明細と請求内容（金額・取引先など）を照合し、どの請求への入金かを見極めること。',
  'glossary.clientCredit.term': '前受金（まえうけきん）',
  'glossary.clientCredit.def': '請求より先に受け取った入金、または請求額を超えた入金の残り。あとで請求に充当できる預り分です。',
  'glossary.allocate.term': '充当（じゅうとう）',
  'glossary.allocate.def': '前受金などの残高を、特定の請求の支払いとして割り当てること。',
} as const

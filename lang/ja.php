...
return [
    ...
    // 段階別テンプレ（再督促 / 最終）。トーンは escalate するが、脅迫的・威圧的・虚偽の表現は禁止（scope X10 / ADR 0011）。
    // !! これらは保守的なドラフト。本番運用前に ADR 0011 のレビュアー（税理士 / 弁護士）でトーンを確認すること。
    'dunning_email.reminder.subject' => '【再度のご案内】請求書 %s のお支払いについて',
    'dunning_email.reminder.body' => "%s 様\n\n"
        . "先般お送りした請求書 %s（お支払期日：%s）について、その後もご入金の確認ができておりません。\n\n"
        . "未収残高：¥%s（%s 現在）\n\n"
        . "恐れ入りますが、至急お支払手続きをお願いいたします。お支払いが難しいご事情がございましたら、お早めにご連絡ください。\n\n"
        . "未収残高 ¥%s のご確認をお願いいたします。\n\n"
        . '行き違いでお振込み済みの場合は、本メールへのご返信は不要です。',
    'dunning_email.final.subject' => '【お支払いに関する重要なご案内】請求書 %s',
    'dunning_email.final.body' => "%s 様\n\n"
        . "請求書 %s（お支払期日：%s）について、これまで複数回ご案内しておりますが、本日時点でご入金の確認ができておりません。\n\n"
        . "未収残高：¥%s（%s 現在）\n\n"
        . "つきましては、お支払い、またはお支払いに関するご連絡を、お早めにお願いいたします。ご不明な点やご事情がございましたら、まずはご相談ください。\n\n"
        . "未収残高 ¥%s。\n\n"
        . '行き違いでお振込み済みの場合は、本メールへのご返信は不要です。',
